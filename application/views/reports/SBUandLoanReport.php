...
<a href="<?php echo site_url('login/homepage'); ?>"> <img src="<?php echo base_url('Assets/images/caritaslogo.png'); ?>" class="caritaslogo"></a>
	...
	<p><b>SAVINGS BUILD-UP = SBU</b></p>
	<table class="savingsbuildup" border="1">
		<tr>
			<td class="num" rowspan="3">SL No.</td>
			<td class="SO1" rowspan="3">Name of LO</td>
			<td class="ctr" rowspan="3">Center No. </td>
			<td colspan="3">No. of Members</td>
			<td colspan="3">Target of Collections</td>
			<td colspan="3">Actual Collections</td>
			<td colspan="3">Withdrawals</td>
			<td colspan="6">Return/Adjustment</td>
			<td class="bal" colspan="2">Balance</td>
			<td class="num" rowspan="3">No. of LO & Trainees</td>
		</tr>
			<tr>
				<td class="subctgry" rowspan="2">Previous</td>
				<td class="subctgry" rowspan="2">Current</td>
				<td class="subctgry" rowspan="2">Total</td>
				...
				<td class="subctgry" colspan="2">Previous</td>
				<td class="subctgry" colspan="2">Current</td>
				<td class="subctgry" colspan="2">Total</td>

				<td class="subctgry1" rowspan="2">Pers</td>
				<td class="subctgry" rowspan="2">Amount</td>

			</tr>

			<tr>
				<td class="subctgry1">Pers</td>
				<td class="subctgry">Amount</td>
				<td class="subctgry1">Pers</td>
				<td class="subctgry">Amount</td>
				<td class="subctgry1">Pers</td>
				<td class="subctgry">Amount</td>
	...
	<!------------------DATA HERE------------------>
	<!------------------TOTAL------------------>
			<tr><td colspan="24" style="height:2px;padding:0;"></td></tr>
			<tr>
				<td class="val2" colspan="2" style="text-align: right;">Total:</td>
				
				<td class="val2"><b></b></td>
				<td class="val"><b></b></td>
				<td class="val"><b></b></td>
				<td class="val"><b></b></td>
				<td class="val"><b></b></td>
	...
	<p><b>SAVINGS BUILD-UP = SBU</b></p>
	<table class="loanreceivable" border="1">
		<tr>
			<td class="num" rowspan="3">SL No.</td>
			<td class="SO1" rowspan="3">Name of LO</td>
			
			<td colspan="6">Loan Disbursement with Interest</td>
			
			<td colspan="3">Amount Due</td>
			<td colspan="3">Actual Collections</td>

			<td class="bal" colspan="2">Balance</td>
			<td class="bal" colspan="2">Outstanding</td>

			<td colspan="6">Full Repayment</td>

			<td class="bal" colspan="2">Repayment Rate</td>
			...
			<tr>
				...
				<td class="subctgry" rowspan="2">Current</td>
				<td class="subctgry" rowspan="2">Cumulative</td>
			</tr>
	...
	<div style="width: 100%; text-align: center;">
		...
		<form action="savetopdf" method="post">

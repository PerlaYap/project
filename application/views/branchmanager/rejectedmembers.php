...
$getMember =$this->db->query("SELECT BranchName, cb.ControlNo, CenterNo, CONCAT(FirstName, ' ', MiddleName, ' ', LastName) AS Name, m.ControlNo, m.Comment
	...
	WHERE m.ControlNo IN (SELECT ControlNo FROM Members WHERE Approved='NO') AND cb.ControlNo = '$branch' AND cb.ControlNo = cc.CaritasBranch_ControlNo AND cc.CaritasCenters_ControlNo = c.ControlNo AND c.ControlNo = cm.CaritasCenters_ControlNo
	AND cm.Members_ControlNo = m.ControlNo AND m.ControlNo = mn.ControlNo ");
			...
			<div class="grid grid-pad">
				...
				<div class="col-1-4">
					<div class="content1">
						...
						<p class="reason">
						<br><br> <b>Reason: </b> <?php echo $result->Comment; ?>
<br><br>

...
$getBranch = $this->db->query("SELECT BranchName, BranchID, BranchAddress, ContactNo, cb.ControlNo, CONCAT(FirstName, ' ', MiddleName, ' ', LastName) AS Manager  FROM caritasbranch cb, branchaddress ba, branchcontact bc, CaritasBranch_has_CaritasPersonnel cp, CaritasPersonnel cl
...
$getManager = $this->db->query("SELECT CONCAT(FirstName, ' ', MiddleName, ' ', LastName) AS Name, ControlNo FROM CaritasPersonnel p,
...
$getBranch2 = $this->db->query("SELECT  cb.ControlNo, CONCAT(FirstName, ' ', MiddleName, ' ', LastName) AS Officer FROM caritasbranch cb, CaritasBranch_has_CaritasPersonnel cp, CaritasPersonnel cl
...
$getOfficer = $this->db->query("SELECT CONCAT(FirstName, ' ', MiddleName, ' ', LastName) AS Name, ControlNo FROM CaritasPersonnel p

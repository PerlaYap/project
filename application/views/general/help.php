...
<div class="content">
	<p class="hdrAbout" STYLE="text-transform: uppercase; text-align:center;">
	...
	<ol style="margin-top: -10px; margin-left: 10px;" type="I">
		<li><a href="#I">SYSTEM INFORMATION</a></li>
		<li><a href="#II">STANDARD PROCEDURES</a></li>
		<li><a href="#III">MIS FUNCTION</a></li>
			<OL type="A">
				<li><a href="#IIIA">ADD NEW USER</a></li>	
				<li><a href="#IIIB">VIEW AND EDIT USER PROFILE</a></li>
				<li><a href="#IIIC">ADD BRANCH</a></li>
				<li><a href="#IIID">VIEW AND EDIT BRANCH INFO</a></li>
			</OL>

		<li><a href="#IV">BASIC USER FUNCTIONS</a></li>
			<OL type="A">
				<li><a href="#IVA">VIEW PROFILE AND CHANGE PASSWORD</a></li>
		...
		<li><a href="#V">BRANCH MANAGER FUNCTIONS</a></li>
			<OL type="A">
				<li><a href="#VA">ADD CENTER</a></li>
				<li><a href="#VB">VIEW AND EDIT CENTER INFO</a></li>
				<li><a href="#VC">APPROVE/REJECT MEMBERSHIP APPLICATIONS</a></li>
				<li><a href="#VD">APPROVE/REJECT LOAN APPLICATIONS</a></li>
				<li><a href="#VE">RELEASE LOAN</a></li>
				<li><a href="#VF">TERMINATE MEMBER</a></li>
				<li><a href="#VG">WITHDRAW MEMBER</a></li>
			</OL>

		<li><a href="#VI">SALVE OFFICER FUNCTIONS</a></li>
			<OL type="A">
				<li><a href="#VIA">ADD NEW MEMBER</a></li>
				<li><a href="#VIB">EDIT PROFILE</a></li>
				<li><a href="#VIC">ADD LOAN APPLICATION</a></li>
				<li><a href="#VID">VIEW PENDING AND REJECTED MEMBERSHIP APPLICATIONS</a></li>
				<li><a href="#VIE">VIEW APPROVED AND REJECTED LOAN APPLICATIONS</a></li>
				<li><a href="#VIF">GENERATE DAILY COLLECTION SHEET</a></li>
				<li><a href="#VIG">RECORD DAILY COLLECTION</a></li>
				<li><a href="#VIH">ADD ADDITIONAL COLLECTION</a></li>
				<li><a href="#V1I">EDIT COLLECTION</a></li>
				<li><a href="#VIJ">VIEW PAST DUES</a></li>
			</OL>

		<li><a href="#VII">REPORT GENERATION</a></li>
			<OL type="A">
				<li><a href="#VIIA">COLLECTION PERFORMANCE OF CENTERS</a></li>
				<li><a href="#VIIB">ACTIVE ACCOUNTS GRAPH</a></li>

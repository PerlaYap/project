    	...
    	<form action="addnewloanprocess1" method="post" name="addnewloanprocess1" class="basic-grey" onSubmit="return check();">
    		...
    		<label>
              ...
              $a=0;
    						...
    						<input required="true" type="number" max='<?php echo $maxloan_1; ?>' min='0' title="Maximum Loan Amount: <?php echo $maxloan_1 ?>" id="loanamount" name='amountreq<?php echo number_format($a, 2) ?>' style="width: 210px;" placeholder="Pesos" />	
                <?php $a++; } ?>
    						&nbsp&nbsp&nbsp&nbsp
    						Max Loan Amount :
